...
const CourseCertificate = ({ id, user, data }: Props) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen">
            <div ref={certificateRef} className="w-[800px] h-[600px] p-10 text-center border-4 border-gray-800 bg-gray-100 shadow-lg bg-[url('https://res.cloudinary.com/polad/image/upload/v1730744863/Black_Gold_and_White_Seminar_Participation_Certificate_wokx1u.png')] bg-cover bg-center">
