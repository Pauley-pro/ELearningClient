...
import { useCreateCourseManagerMutation } from '@/redux/features/courses/coursesApi';
...
const CreateCourse = (props: Props) => {
    const [createCourse, { isLoading, isSuccess, error }] = useCreateCourseManagerMutation();
    useEffect(() => {
        if (isSuccess) {
