...
const CourseContentMedia = ({ data, id, activeVideo, setActiveVideo, user, refetch }: Props) => {
    ...
    const handleQuestion = () => {
        if (question.length === 0) {
            toast.error("Qestion can't be empty");
        } else {
    ...
    }, [isSuccess, error, answerSuccess, answerError, reviewSuccess, reviewError, replySuccess, replyError, activeVideo, courseRefetch, data, refetch, user._id, user.role]);

    const handleAnswerSubmit = () => {
        addAnswerInQuestion({ answer, courseId: id, contentId: data[activeVideo]._id, question: questionId });
    };
        ...
        <div className="w-[95%] 800px:w-[86%] py-4 m-auto">
            ...
            <div className="w-full p-4 flex items-center justify-between bg-slate-500 bg-opacity-20 backdrop-blur shadow-[bg-slate-700] rounded shadow-inner">
                {["Overview", "Resources", "Q&A", "Review"].map((text, index) => (
                    <h5
                        key={index}
                        className={`800px:text-[20px] text-[#fff] cursor-pointer ${activeBar === index && "text-red-500"
                            }`}
            ...
            <br />
            {activeBar === 0 && (
                <p className="text-[18px] dark:text-[#fff] text-black whitespace-pre-line mb-3">
            ...
            {activeBar === 2 && (
                <>
                    <div className="flex w-full">
                        <Image
                            src={user.avatar ? user.avatar.url : "https://res.cloudinary.com/polad/image/upload/v1702556497/avatars/z4hdjppwz2wrjmuerdln.png"}
                            alt=""
                            width={50}
                            height={50}
                        ...
                        <textarea
                            ...
                            className="outline-none bg-transparent ml-3 border border-[#ffffff57] 800px:w-full p-2 rounded w-[90%] 800px:text-[18px] text-[#fff] font-Poppins"
                        ></textarea>
                    </div>
                                ...
                                !isReviewExists && (
                                    <>
                                        <div className="flex w-full">
                                            ...
                                            />
                                            <div className="w-full">
                                                <h5 className="pl-3 text-[20px] font-[500] dark:text-[#fff] text-black">
                                                ...
                                                <textarea
                                                    ...
                                                    className="outline-none bg-transparent 800px:ml-3 border border-[#ffffff57] w-[95%] 800px:w-full p-2 rounded text-[18px] text-[#fff] font-Poppins"
                                                ></textarea>
                                            </div>
                                        </div>
                                        <div className="w-full flex justify-end">
                                    ...
                                    return (
                                        <div className="w-full my-5 dark:text-white text-black" key={index}>
                                            <div className="w-full flex">
                                                <div>
                                                    <Image
                                                        src={item.user.avatar ? item.user.avatar.url : "https://res.cloudinary.com/polad/image/upload/v1702556497/avatars/z4hdjppwz2wrjmuerdln.png"}
                                                        alt=""
                                                        width={50}
                                                        height={50}
                                                        className="w-[50px] h-[50px] rounded-full object-cover"
                                                ...
                                                item.commentReplies.map((i: any, index: number) => (
                                                    <div className="w-full flex 800px:ml-16 my-5" key={index}>
                                                        <div className="w-[50px] h-[50px]">
                                                            <Image
                                                                src={i.user.avatar ? i.user.avatar.url : "https://res.cloudinary.com/polad/image/upload/v1702556497/avatars/z4hdjppwz2wrjmuerdln.png"}
                                                                alt=""
                                                                width={50}
                                                                height={50}
                                                                className="w-[50px] h-[50px] rounded-full object-cover"
...
const CommentReply = ({
    ...
    return (
        <>
            <div className="w-full my-3 dark:text-[#fff]">
                {
    ...
    return (
        <>
            <div className="my-4">
                ...
                <div className="w-full flex">
                    <span className="800px:pl-16 text-[#000000b8] dark:text-[#ffffff83] cursor-pointer mr-2" onClick={() => { setReplyActive(!replyActive), setQuestionId(item._id); }}>
