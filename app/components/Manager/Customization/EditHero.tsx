...
import { useEditLayoutManagerMutation, useEditLayoutMutation, useGetHeroDataQuery } from '@/redux/features/layout/layoutApi';
...
const EditHero: FC<Props> = (props: Props) => {
    ...
    const [editLayout, { isLoading, isSuccess, error }] = useEditLayoutManagerMutation();
    ...
    return (
        <>
            <div className="w-full 1000px:flex items-center">
                ...
                <div className="1000px:flex 1000px:min-h-screen items-center justify-between pt-[70px] 1000px:pt-[0] z-10">
                    <div className="relative flex items-center justify-center 1000px:w-[40%]">
                        <Image
                            src={image}
                            alt=""
